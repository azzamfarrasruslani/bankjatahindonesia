...
export default function LokasiMap({
  ...
  const avgLat =
    filteredData.length > 0
      ? filteredData.reduce((sum: any, l: any) => sum + parseFloat(l.latitude || 0), 0) /
        filteredData.length
      : 0.5071; // Default
  const avgLng =
    filteredData.length > 0
      ? filteredData.reduce((sum: any, l: any) => sum + parseFloat(l.longitude || 0), 0) /
        filteredData.length
      : 101.4478; // Default
