...
export default function LokasiFormSheet({ isOpen, onClose, onSuccess, lokasiId = null }: any) {
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <input
                        type="text"
                        value={form.latitude ?? ""}
                        onChange={(e: any) => setForm(p => ({...p, latitude: e.target.value}))}
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onChange={(e: any) => setForm(p => ({...p, longitude: e.target.value}))}
                        className="w-full border-none bg-gray-50 rounded-2xl px-6 py-3 text-sm font-bold text-gray-900 focus:ring-2 focus:ring-orange-100 outline-none transition-all"
                      />
                    </div>
                  </div>
