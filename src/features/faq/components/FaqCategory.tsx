  ...
  return (
    <div className="mb-20 scroll-mt-32 relative">
      ...
      <div className="space-y-4">
        {section.faqs.map((faq: any, faqIdx: any) => {
          const key = `${categoryIdx}-${faqIdx}`;
          return (
            <FaqItem
              key={faqIdx}
