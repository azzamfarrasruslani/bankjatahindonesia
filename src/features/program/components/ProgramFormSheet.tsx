...
export default function ProgramFormSheet({
  ...
  const handleDetailChange = (i: any, value: any) => {
  ...
  const removeDetail = (i: any) => {
    if (form.details.length <= 1) return;
    setForm({ ...form, details: form.details.filter((_: any, j: any) => j !== i) });
  };
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    <AnimatePresence initial={false}>
                      {form.details.map((step: any, i: any) => (
                        <motion.div
                          key={i}
