...
import { BeritaTopCard, BeritaCard } from "@/features/berita";
...
export default function BeritaPage() {
  ...
  const topNews = beritaList.find((b: any) => b.is_top) || beritaList[0];
  const otherNews = topNews
    ? beritaList.filter((b: any) => b.id !== topNews.id)
    : [];
