  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col flex-grow p-6 relative z-10">
        ...
        {/* Title */}
        <Link href={`/artikel/${id}`} className="block mb-3 group/link">
        ...
        {/* Excerpt */}
        <div className="text-gray-500 text-sm leading-relaxed font-light line-clamp-3 mb-6 flex-grow border-l-2 border-orange-100 pl-4 py-1">
          {excerpt
            ? parse(excerpt.replace(/<[^>]+>/g, "").slice(0, 150) + "...")
            : "Simak selengkapnya wawasan ini di halaman artikel."}
        </div>
