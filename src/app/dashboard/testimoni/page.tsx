...
import TestimoniFormSheet from "@/features/testimoni";
import ConfirmDeleteModal from "@/components/common/ConfirmDeleteModal";
import { useTestimoni } from "@/features/testimoni";
          ...
          <TableBody>
            <AnimatePresence mode="wait">
              {loading ? (
                ...
                testimoniList.map((item: any, index: any) => (
                  <motion.tr
                    key={item.id}
                  ...
                  >
                    ...
                    <TableCell className="text-center">
                      <div className="flex justify-center gap-0.5 text-yellow-400 drop-shadow-sm">
                        {Array.from({ length: item.rating }).map((_: any, i: any) => (
