...
export default function BeritaForm({ beritaId, onSuccess }) {
  ...
  const [loadingData, setLoadingData] = useState(!!beritaId);
                ...
                {preview ? (
                  <div className="relative w-full h-full rounded-2xl overflow-hidden shadow-md">
                    ...
                    <div className="absolute inset-0 bg-black/40 opacity-0 group-hover/upload:opacity-100 transition-opacity flex items-center justify-center">
                      <p className="text-white font-bold text-sm">Ganti Gambar Berita</p>
                    </div>
                  </div>
                ) : (
                  <div className="flex flex-col items-center text-center p-8">
                    ...
                    <p className="text-xs text-gray-400 mt-1">Gunakan format WebP untuk performa terbaik</p>
                  </div>
                )}
              </div>
            </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="space-y-3">
              ...
              <input
                ...
                className="w-full border-2 border-gray-100 rounded-[1.2rem] px-5 py-4 focus:border-[#FB6B00] focus:ring-0 outline-none bg-gray-50/50 hover:bg-white transition-all font-medium text-gray-900 placeholder:text-gray-300"
              />
            </div>
      ...
      <div className="flex items-center justify-end gap-4 pt-8 border-t border-gray-100 mt-12">
        ...
        >
          {loadingSubmit ? (
            ...
            <>
              {beritaId ? "Simpan Perubahan Berita" : "Publikasikan Berita"}
